...
class TestSaaSConnectorLoadBalancing:
    ...
    def test_respects_max_tables_per_pipeline(self, salesforce_connector):
        ...
        df = pd.DataFrame({
            ...
            'pipeline_catalog': ['main'] * 10,
            'pipeline_schema': ['salesforce'] * 10,
...
class TestDatabaseConnectorLoadBalancing:
    ...
    def test_pipeline_naming_within_gateway(self, sqlserver_connector):
        ...
        df = pd.DataFrame({
            ...
            'pipeline_catalog': ['main'] * 100,
            'pipeline_schema': ['bronze'] * 100,
...
class TestValidateGeneratedNames:
    ...
    def test_name_collision_across_projects(self, salesforce_connector):
        ...
        df = pd.DataFrame({
            ...
            'pipeline_catalog': ['main'] * 4,
            'pipeline_schema': ['salesforce'] * 4,

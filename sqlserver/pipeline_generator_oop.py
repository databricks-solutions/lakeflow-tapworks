"""
SQL Server pipeline generation using OOP architecture.

This script demonstrates the use of the SQLServerConnector class for
pipeline generation. It provides a simplified interface compared to the
functional approach, with all connector-specific logic encapsulated in
the connector class.

Usage:
    # Command line
    python pipeline_generator_oop.py --input-csv input.csv --output-dir output --workspace-host https://...
...
Examples:
  # Basic usage
  python pipeline_generator_oop.py \\

...
Examples:
  ...
  python pipeline_generator.py \\
    ...
    --default-values '{"project_name": "workday_reports_ingestion", "schedule": "0 */12 * * *"}'
...
Config file format (JSON or YAML):
  {
    ...
    parser.add_argument(
        ...
        help=f'Maximum reports per pipeline (default: {BaseConnector.DEFAULT_MAX_TABLES_PER_PIPELINE})'
    )
    parser.add_argument(
        '--schedule',
        type=str,

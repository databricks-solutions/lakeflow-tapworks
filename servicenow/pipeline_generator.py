"""
ServiceNow pipeline generation using OOP architecture.

This script demonstrates the use of the ServiceNowConnector class for
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate ServiceNow ingestion pipelines using OOP architecture",
...
Note:
  ...
  - Default SCD type is SCD_TYPE_2 (can be overridden to SCD_TYPE_1 per table)
        """,
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to input CSV with ServiceNow tables (required)",
    )
    parser.add_argument(
        "--project-name",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=250,
        help="Maximum tables per pipeline (default: 250)",
    )
    parser.add_argument(
        "--schedule",
        type=str,
